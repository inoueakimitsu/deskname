...
[Setup]
AppId={{B4D6C370-5F7A-4D3B-9584-A8F9E8E9D2A0}}
AppName={#MyAppName}
...
LicenseFile=LICENSE
OutputDir=Output
OutputBaseFilename=DeskName_Setup
Compression=lzma
...
Name: "startup"; Description: "Windows起動時に自動的に起動"; GroupDescription: "自動起動:"; Flags: unchecked
